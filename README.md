...
- **DatosBancos.xlsx** → Dataset utilizado en el caso práctico del TFG.  
...
## Objetivos del TFG
1. Estudiar los fundamentos matemáticos de los LLMs.  
2. Implementar la técnica **LoRA** para optimizar modelos de lenguaje en tareas específicas.  
3. Comparar el rendimiento frente a algoritmos clásicos de Machine Learning.  
4. Analizar la eficiencia y adaptabilidad de cada enfoque. 
